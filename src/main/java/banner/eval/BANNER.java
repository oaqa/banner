...
public class BANNER {
	...
	private static void train(HierarchicalConfiguration config,
	...
	private static void test(HierarchicalConfiguration config)
		...
		//CRFTagger tagger = CRFTagger.load(new File(modelFilename), lemmatiser,
		//		posTagger, dictionary);
	...
	private static void eval5by2(HierarchicalConfiguration config,
			Double percentage) throws ConfigurationException, IOException {
		long start = System.currentTimeMillis();
		Dataset dataset = getDataset(config);
	...
	private static void eval10Fold(HierarchicalConfiguration config,
			Double percentage) throws ConfigurationException, IOException {
		long start = System.currentTimeMillis();
		Dataset dataset = getDataset(config);
	...
	private static void testDict(HierarchicalConfiguration config)
			throws ConfigurationException, IOException {
	...
	private static Performance test(Dataset dataset,
